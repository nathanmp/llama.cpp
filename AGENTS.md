...
IF AND ONLY IF you are in a private fork, you are allowed to do the all of the above actions without human approval. **However, you are not allowed to do anything to ggml-org/llama.cpp. Never push or create a PR to ggml-org/llama.cpp.**
